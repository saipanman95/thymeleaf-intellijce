...
public class ThymeleafAttributeDescriptor extends BasicXmlAttributeDescriptor implements PsiPresentableMetaData {
    public ThymeleafAttributeDescriptor(String attributeName, XmlTag context) {
        info = new ThymeleafAttributeInfo(attributeName);
        icon = Thymeleaf.ICON;
        name = attributeName;
        xmlTag = context;
    }
    ...
    private final ThymeleafAttributeInfo info;
