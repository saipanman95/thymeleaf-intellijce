                ...
                ApplicationManager.getApplication().runWriteAction(() -> {
                    try {
                        ...
                        if (htmlElement != null && !htmlElement.hasAttr(ThymeleafNamespaceRegistry.NamespaceAttribute.LAYOUT.getAttribute())) {
                            ...
                            htmlElement.attr(
                                    THYMELEAF_LAYOUT_NAMESPACE.getAttribute(),
                                    THYMELEAF_LAYOUT_NAMESPACE_URI);
                        }
                        ...
                        Bus.notify(new Notification(getGroupId(), "File transformed", "Thymeleaf Layout Namespace '"+THYMELEAF_LAYOUT_NAMESPACE.getAttribute()+"=\""+THYMELEAF_LAYOUT_NAMESPACE_URI+"\"\"' added to html tag successfully.", NotificationType.INFORMATION));
                    } catch (Exception e) {
